        ...
        <div className="bg-background min-h-full pb-24 safe-area-inset-bottom">
            ...
            <div className="flex items-center justify-between px-4 py-3">
                ...
                <button
                    ...
                    className="flex items-center gap-2 bg-blue-50 dark:bg-blue-900/50 px-4 py-2 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors active:scale-95"
                >
            ...
            {/* Balance Card */}
            <div className="bg-card mx-4 rounded-2xl shadow-sm border border-border p-6 mb-4">
            ...
            <div className="flex gap-4 px-4 mb-4">
                <div className="flex-1 bg-green-50 dark:bg-green-900/20 rounded-2xl p-4">
                    <div className="w-12 h-12 bg-green-100 dark:bg-green-900/40 rounded-full mb-3 flex items-center justify-center">
                ...
                <div className="flex-1 bg-green-50 dark:bg-green-900/20 rounded-2xl p-4">
                    ...
                    <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/40 rounded-lg mb-2 flex items-center justify-center">
            ...
            {/* Account Activation */}
            <div className="flex items-center justify-between mx-4 mb-4 p-4 bg-muted rounded-2xl">
                <div className="flex items-center gap-3">
                    <div className="relative w-12 h-12">
                        ...
                        <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-blue-600 rounded-full border-2 border-background" />
                    </div>
                    <div>
