        ...
        <div className="bg-background min-h-full pb-24 safe-area-inset-bottom">
            ...
            <div className="flex items-center justify-between px-4 py-3">
                ...
                <button
                    ...
                    className="flex items-center gap-2 bg-blue-50 dark:bg-blue-900/30 px-4 py-2 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors active:scale-95"
                >
