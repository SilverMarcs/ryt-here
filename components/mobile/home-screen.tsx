...
export const HomeScreen = ({ onTabChange }: HomeScreenProps) => {
  return (
    <div className="bg-white min-h-screen pb-20">
      ...
      <div className="flex items-center justify-between px-4 py-3">
        <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center">
          <span className="text-blue-600 font-semibold text-sm">LT</span>
        </div>
        <Link
          href="/chat"
        ...
        >
          ...
          <span className="text-blue-600 font-medium text-sm">Ask Ryt AI</span>
        </Link>
      ...
      <div className="bg-white mx-4 rounded-2xl shadow-sm border border-gray-100 p-6 mb-4">
        ...
        <div className="text-4xl font-bold mb-2">RM 0.00</div>
        <div className="flex items-center gap-2">
          <span className="text-gray-600 text-sm">Interest earned</span>
          <span className="text-green-600 font-semibold">+RM 0.00</span>
        </div>
      </div>
      ...
      <div className="flex gap-4 px-4 mb-4">
        <div className="flex-1 bg-green-50 rounded-2xl p-4">
          <div className="w-12 h-12 bg-green-100 rounded-full mb-3 flex items-center justify-center">
            <span className="text-green-600 font-bold text-xs">RM</span>
          </div>
        ...
        <div className="flex-1 bg-blue-50 rounded-2xl p-4">
          ...
          <div className="w-16 h-16 bg-blue-100 rounded-lg mb-2 flex items-center justify-center">
            <span className="text-blue-600 text-xs font-bold">RM</span>
          </div>
          <a href="#" className="text-blue-600 text-xs font-medium">
            Apply now &gt;
          </a>
      ...
      {/* Account Activation */}
      <div className="flex items-center justify-between mx-4 mb-4 p-4 bg-gray-50 rounded-2xl">
        <div className="flex items-center gap-3">
          <div className="relative w-12 h-12">
            <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
              <span className="text-blue-600 font-bold text-xs">RM</span>
            </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-600">1 of 6 completed &gt;</p>
          </div>
        </div>
      ...
      <div className="flex items-center justify-between mx-4 px-4 py-2">
        ...
        <div className="flex items-center gap-1">
          <span className="text-blue-600 font-semibold">3.0% p.a.</span>
          <span className="text-gray-400">+</span>
          <span className="text-gray-500 text-sm">1.0% p.a.</span>
        </div>
      </div>
