            ...
            {!isCompleted && onContribute && (
                <>
                    <Button
                        variant="ghost"
                        size="sm"
                        className="w-full text-xs border border-white/20 bg-white/5 hover:bg-white/10 hover:border-white/30 rounded-lg"
                    ...
                    {isExpanded && (
                        <div className="space-y-3 pt-2 border-t">
                            ...
                            <Button
                                ...
                                className="w-full"
                                onClick={() =>
                                    handleContribute(goal.id, contributeAmount)
                                }
                            >
...
export const SavingsGoalCard = ({
    ...
    const totalSaved = displayGoals.reduce(
        (sum, g) => sum + g.currentAmount,
        0
    );
    const totalTarget = displayGoals.reduce(
            ...
            <CardContent className="pt-0 space-y-3">
                ...
                {displayGoals.length > 2 && (
                    ...
                    >
                        {showAll
                            ? "Show less"
                            : `Show all ${displayGoals.length} goals`}
                    </Button>
                )}
